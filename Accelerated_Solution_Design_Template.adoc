...
_<Reference here any kind of visual presentation (like Power Point) that you have about your
 ...
 and the behaviour of the future solution to your customer. Template example link:https://github.com/devonfw/devon-methodology/blob/master/ADCenter_First_Steps_Analysis_Document_TEMPLATE.POTX[here]>_
