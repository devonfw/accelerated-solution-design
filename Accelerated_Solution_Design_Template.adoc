...
_<Reference here any kind of visual presentation (like Power Point) that you have about your
 ...
 and the behaviour of the future solution to your customer. Example link:https://github.com/jdiazgon/devon-methodology/blob/ASD_Practices/references/JumpTheQueue/design/171124_ADCenter_JTQ_First_Steps_Analysis_Document_V1_3.pptx[here]>_
