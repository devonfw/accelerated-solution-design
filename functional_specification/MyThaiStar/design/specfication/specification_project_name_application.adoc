...
:imagesdir: ./images/
:imagesComponentNameManagement: /BCO_ComponentName_Management/images/
...
image::{imagesComponentNameManagement}business_component_ComponentName_management.svg[caption="Figure 2: ", title="Business Component _<Component_Name>_ <Action_Name>", alt="Business Component _<Component_Name>_ <Action_Name>"]
...
image::{imagesComponentNameManagement}mco_ComponentName.svg[caption="Figure 3: ", title="Model Component MCO_<Component_Name>", alt="Model Component MCO_<Component_Name>"]
...
image::{imagesComponentNameManagement}eif_manage_ComponentName.svg[caption="Figure 4: ", title="External Interface EIF_<Action_Name>_<Component_Name>", alt="External Interface EIF_<Action_Name>_<Component_Name>"]
