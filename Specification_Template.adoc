...
[NOTE]
====
*_Goal of the architectural overview:_* _The architectural overview describes the integration of the specified application into the application landscape of the customer. It identifies the neighboring systems and displays its interfaces._
...
_A use case function is defined just like a normal use case, but without the naming of an actor: This use case is not used by an actor, but by another use case function or another use case._
====
