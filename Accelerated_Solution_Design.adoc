...
Click link:https://github.com/devonfw/devon-methodology/blob/ASD_Pracices/references/JumpTheQueue/design/JumpTheQueue.adoc[here] to access a sample in GitHub and link:https://confluence.s2-eu.capgemini.com/display/ACM/Jump+The+Queue+Project[here] on Confluence
