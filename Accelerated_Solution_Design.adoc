...
The following link:https://github.com/devonfw/devon-methodology/blob/master/extracted-media/mediaASD/%5BProject%20Code%5D__%5BProject%20Name%5D_Analysis_Overview_v%5B1.0%5D_YYYYMMDD.dotx[document] shows sample content of this document.
...
* Site map and sketches of the user interfaces that shall meet the requirements
 ...
 The powerpoint template can be found at following link:https://github.com/devonfw/devon-methodology/blob/master/extracted-media/mediaASD/ADCenter_First_Steps_Analysis_Document_TEMPLATE.potx[link]
...
Click link:https://github.com/devonfw/devon-methodology/blob/master/references/JumpTheQueue/design/JumpTheQueue.adoc[here] to access a sample in GitHub and link:https://confluence.s2-eu.capgemini.com/display/ACM/Jump+The+Queue+Project[here] on Confluence
...
link:https://github.com/devonfw/devon-methodology/blob/master/extracted-media/mediaASD/UAT_Template_v1.xlsx[UAT_Template_v1.xlsx]
